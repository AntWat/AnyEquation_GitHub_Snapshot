...
namespace Xamarin.FormsBook.Toolkit
{
    public class NamedColor
    {
        ...
        public int Brightness { get { return GetBrightness(Color); } }
        ...
        static NamedColor()
        {
            ...
            foreach (FieldInfo fieldInfo in typeof(NamedColor).GetRuntimeFields ())
            {
                if (fieldInfo.IsPublic &&
                    ...
                    !fieldInfo.Name.Equals("Transparent"))
                {
        ...
        // ----------------------
        NamedColor FindNamedColor(string name)
        {
        ...
        // ---------------------- choose whether black or white is a better choice for text or border against a coloured background.
        /// These 2 routines are useful to choose whether black or white is a better choice for text or border against a coloured background.
        /// The method and code is from:
        ...
        public static Color BlackOrWhiteForContrast(Color? backgroundColor)
        {
            ...
            {
                double br = GetBrightness((Color)backgroundColor);
                Color c = br < 130 ? White : Black;
                return c;
            }
        }
        ...
        public static Color BlendColors(Color color, Color backColor, double amount)
        {
        ...
        public static readonly Color Transparent = Color.FromRgba(0, 0, 0, 255);
